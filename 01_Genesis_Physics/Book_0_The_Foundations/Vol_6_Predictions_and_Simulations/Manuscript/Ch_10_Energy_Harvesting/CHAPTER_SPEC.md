...
|--------|--------------------|-----------|--------|
| Ch10-001 | Derive the Firmament Resonance Generator (MRG) from Firmament mechanics (Vol 1 Ch 5) and the Dynamic Casimir Effect | V6-001 (predictions numbered) | PLANNED |
...
| Electromagnetic field quantization on the Firmament | Vol 2, Ch 11; Vol 4, Ch 7 |
...
5. **Why are there exactly four harvesting categories?** — Because the zone architecture presents exactly four energy-bearing features: Firmament tension (→ MRG, vacuum), Waters field density gradients (→ Waters-field extraction), zone-boundary potential steps (→ phase-transition / condensation), and intrinsic reservoir depth (→ capacitor discharge). Every proposed method maps to one or more of these.
...
| 2 | Casimir pressure as Firmament measurement | π²ħc/(240a⁴) reinterpreted | F/A = 208 Pa at a = 50 nm — direct measurement of Firmament mode suppression |
...
|--------|-------|------|-----------|---------------|-----------------|-----------|
| Fig 6.10.1 | The Four Energy-Bearing Features of Zone Architecture | Schematic | §10.1 | Capacitor, Firmament tension, field gradients, zone boundaries as labelled regions of the 6D manifold | Sets the taxonomy for the chapter | Complex |
...
- **Content:** Cosmic capacitor (Waters separation), Firmament tension (Firmament vibration), Waters-field density gradients, zone-boundary potentials. Connection to Ch 9 (FTL energy budgets).
...
- **Content:** Drumhead analogy, quantum vacuum fluctuations as Firmament modes, conservative Casimir (η = 0) vs driven steady state (η > 0), observational evidence for active sustaining (accelerating expansion = ρ_Λ continuously supplied), definition of η, compatibility with Second Law via open-system axiom.
...
### Section 10.5: The Firmament Resonance Generator — Device Physics and Reference Design
...
- **Topic sentence:** Two adjacent categories: the Firmament membrane-tension vacuum energy (accessible with tabletop MRG-class devices) and the zone-boundary latent energy (highest energy density but highest risk).
- **Content:** Casimir as a *local* manifestation of Firmament tension (ρ_vacuum ≈ 5.96 × 10⁻¹⁰ J/m³ locally; theoretical QFT estimate 10^113 J/m³ and its resolution via zone architecture (Vol 4 Ch 9)); dynamic Casimir vs static Casimir; Casimir arrays at scale. Zone-boundary transitions: pair production, nuclear binding, accretion near membrane puncture points, controlled oscillation near condensation thresholds. Risk analysis for zone-boundary puncture. Predictions P-115 through P-118.
...
- Centerpiece is the Firmament Resonance Generator from `Research/Papers/membrane_resonance_generator.docx`.

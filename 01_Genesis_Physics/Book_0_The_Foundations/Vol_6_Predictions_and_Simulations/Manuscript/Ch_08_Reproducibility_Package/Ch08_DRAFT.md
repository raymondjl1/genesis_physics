...
- **ΛCDM** (standard cosmology): Ω_m = 0.3, Ω_Λ = 0.7 (illustrative round-number ΛCDM values used by the simulation; the framework's canonical observational baseline is the Planck result quoted in Ch 1 and Ch 4)

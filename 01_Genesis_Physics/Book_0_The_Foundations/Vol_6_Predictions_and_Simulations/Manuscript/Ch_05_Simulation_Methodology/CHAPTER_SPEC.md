...
| Firmament membrane wave equation and boundary conditions | Vol 1, Ch 5, Eqs (1.5.12)–(1.5.18) |
...
| Eigenvalue problem K φ = λ M φ | Firmament membrane spectrum numerical method | Eq (6.5.10)–(6.5.12) |

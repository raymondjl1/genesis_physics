...
A 1 kg spacecraft attempts to quantum tunnel through a zone boundary at the interface between Firmament and Waters Below. The potential barrier has height V₀ = σ²/(2μ). With canonical σ = 6.0×10⁹⁸ kg/(m·s²) and μ = 6.7×10⁸¹ kg/m³ (Symbol_and_Constants.md), V₀ ~ 10¹¹⁵ in SI base units (legacy value 10⁹⁸ J). The qualitative conclusion (FTL forbidden by quantum tunneling) is strengthened, not weakened. Width L ~ 10^-20 m (Planck scale). [TODO 0516_Rev_001: σ²/(2μ) is dimensionally inconsistent — the proper barrier-height formula must include a hidden length factor; author verification needed.]
...
(c) Plug in numbers: m = 1 kg, ℏ = 1.05 × 10^-34 J·s, V₀ ~ 10¹¹⁵ J (canonical σ²/(2μ); legacy 10⁹⁸ J), L = 10^-20 m.

...
2. The critical insight: c is a Firmament property, not a universal law
   - Axiom 3: c² = σ/μ — the speed of light is the wave speed on the Firmament membrane
   - Cite Vol 1, Ch 5 for Firmament membrane mechanics; Vol 5, Ch 2 for GR derivation
...
**Exit:** Reader understands that c is local to the Firmament, the bulk has independent causal structure, and five distinct geometric features each enable effective FTL.
...
3. The DEMANDS / PERMITS / FORBIDS table (from honest assessment):
   - DEMANDS: c is Firmament property; bulk has independent causal structure; warped geometry creates shortcuts
   - PERMITS: Gravitational signals via bulk; matter at extreme energies; local c modification via Waters field
   - FORBIDS: FTL on Firmament by exceeding c; vacuum energy extraction in Phase 3; Phase 2/4 via human technology alone
...
- P-XXX: General FTL predictions (c as Firmament property, bulk independent causal structure)

...
1. Why FTL possible despite relativity forbidding it? → c is brane property (§9.1) ✓
...
2. **§9.3 (Dimensional Bypass)** should include:
   ...
   - "FORBIDS matter from following easily because binding energy to escape brane is extreme (10^25–10^28 J)"

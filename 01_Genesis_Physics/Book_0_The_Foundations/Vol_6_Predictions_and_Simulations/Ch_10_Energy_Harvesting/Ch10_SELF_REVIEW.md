...
|---|---|---|---|
| Ch10-001 | Derive MRG from Firmament membrane mechanics (V.1.5) and Dynamic Casimir Effect | MET | §10.5.2 (TE₁₁ derivation), §10.5.3 (dynamic-Casimir boundary), §10.5.6–§10.5.7 (gross-power derivation) |

...
- Explicit channel geometry: transmitter on brane excites a signal with η-component; signal geodesics through Waters Below; receiver on brane at 4D-spacelike separation receives.
...
- Observable signatures: on-brane EM leakage at the transmitter antenna (predicted spectral line); anomalous signal correlated at spacelike-separated receivers.
...
- Transmitter concept: modulated Membrane Resonance Generator from Ch 10 §10.5 — drive the dielectric oscillation frequency (the symmetry-breaking bias in Ch 10) as the modulation signal. The MRG becomes a radio station for Ψ_A.

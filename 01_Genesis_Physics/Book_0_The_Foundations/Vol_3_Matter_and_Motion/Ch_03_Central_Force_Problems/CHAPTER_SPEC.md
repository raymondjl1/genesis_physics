...
3. **Why $T^2 \propto a^3$ (Kepler's 3rd law)?** — Because for a $1/r$ potential (derived, not postulated), the period depends only on the semi-major axis and the central mass. The specific proportionality constant involves $G_4$, which is determined by membrane tension and effective coupling length (Vol 2 Eq. 2.2.29).

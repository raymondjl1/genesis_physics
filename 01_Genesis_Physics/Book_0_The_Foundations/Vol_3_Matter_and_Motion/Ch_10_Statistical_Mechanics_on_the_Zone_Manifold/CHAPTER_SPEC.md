...
- **Topic sentence:** Statistical mechanics is the bridge between the microscopic world of quantized membrane modes and the macroscopic thermodynamic laws derived in Chapter 9.
...
- **Key content:** Standing waves in a cavity; k-space lattice; positive octant counting; polarization factor; g(ν) = 8πν²/c³ derived; equivalent expressions in λ and ω; comparison with membrane mode spectrum from Vol 1 Ch 5.

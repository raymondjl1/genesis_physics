...
$$\mathcal{L}_\text{zone} = \frac{1}{2\kappa_6^2} R_6 + \mathcal{L}_\text{brane}\,\delta_\Sigma + \mathcal{L}_\text{waters} + \mathcal{L}_\text{gauge} + \mathcal{L}_\text{matter} + \mathcal{L}_\text{Yukawa} + \kappa(t)\,\mathcal{O}_\text{sustain} \tag{2.5.20}$$

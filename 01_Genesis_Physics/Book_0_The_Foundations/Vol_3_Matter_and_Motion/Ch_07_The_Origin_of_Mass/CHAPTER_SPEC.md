...
| Ch07-003 | Show spontaneous electroweak symmetry breaking: VEV v = 246.22 GeV from membrane tension | V3-002 | NOT MET |
...
2. **Why does the Higgs field have a Mexican hat potential?** — Because the Firmament membrane tension creates a negative mass-squared boundary contribution that makes the symmetric vacuum unstable, forcing the field to a non-zero minimum.
3. **Why is the electroweak scale ~246 GeV and not some other value?** — Because the VEV is determined by the membrane tension σ and the zone extent ξ_A — both set by the 6D geometry, not by arbitrary parameters.
...
| Fig 3.7.3 | Mexican hat potential from membrane boundary | Schematic/Plot | §7.2, after Eq. 3.7.12 | Before/after: symmetric potential → tilted Mexican hat as membrane coupling switches on | Transformation that drives SSB; geometric meaning of parameters | μ², λ, v, H axes; vacuum circle S¹ | 3.7.6–3.7.12 | Medium |
...
| Conceptual | 3 | Why membrane tension drives SSB; why photon stays massless; why heavier generations = lower ξ-modes |
...
- **Topic sentence:** The Firmament membrane tension creates a negative mass-squared contribution that makes the symmetric vacuum unstable, generating the Mexican hat potential from geometry rather than assumption.
- **"Why" entry point:** In the Standard Model, the Higgs potential V = -μ²|H|² + λ|H|⁴ is postulated. Where does it come from?
- **Key content:** Boundary conditions at ξ = 0; membrane tension coupling; derivation of μ² ∝ σc²/ξ_A²; quartic coupling λ from KK overlap integrals; the complete effective 4D potential.
...
- [ ] Higgs potential DERIVED from membrane tension, not postulated

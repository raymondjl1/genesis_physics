...
- **Vol 1 Ch 3 (Zone Manifold):** Topology and stratification of the 9 zones; codimension-2 Firmament brane $Z_{2.2}$.
...
- **Vol 1 Ch 5 (Firmament Manifold):** Brane tension, junction conditions, membrane wave speed $c$.
...
| Fig 5.1.2 | KK reduction geometry | §1.2 | Cross-section of 6D manifold showing 4D brane, extra dimensions $(\xi,\eta)$, warp-factor profile $e^{2A}$, and the integration "slab" that produces the 4D action | Spatial: the reader must see what "integrate over the extra dimensions" means geometrically | Cross-section | Medium |

...
- **G3** — Precise brane-tension coefficient $c_\sigma$ from a 6D matched-asymptotic calculation.
...
- Flags two zone-framework falsifiers: the scalar breathing mode and the brane-tension orbital correction, both with numerical predictions and named sensitivity floors.

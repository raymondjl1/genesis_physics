...
- §9.1.2 From Vol 1 Ch 5: brane mechanics, membrane viscosity (used in §9.8.2 for the membrane interpretation of Silk damping).
...
- §9.8.2 The framework's *additional* interpretation: in the brane picture, dissipation of acoustic oscillations on the brane couples the brane modes to extra-dimensional fluctuations of the Waters fields; the effective membrane viscosity from Vol 1 Ch 5 yields a damping scale of the same order. This is *not* a separate damping mechanism — it is the same dissipation seen in the bulk picture.

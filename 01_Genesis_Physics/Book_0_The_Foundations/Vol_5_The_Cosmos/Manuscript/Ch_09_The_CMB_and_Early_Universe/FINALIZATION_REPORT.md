...
| **F2** | Footnote on convergence of radiation-era integral at Firmament-nucleation surface | **APPLIED** | §9.5.2, after Eq (5.9.19). One-sentence inline rationale: integrand $\propto (1+z)^{-3}$ in the deep radiation era falls fast enough that the upper-limit contribution dominates. |
...
| R5.9.3 | Recombination from Saha + Firmament plasma | **MET** | §9.3 |

...
- §11.3 NFW: "why" = Firmament Yukawa + Jeans equation. ✓
- §11.3.4 BTFR slope 4: "why" = Firmament–bulk coupling + virial self-consistency, derived in §11.3.4.1. ✓
...
- $\Lambda_A^{(4)}$: Firmament-projected cosmological constant; matches Vol 1 Eq (1.6.32). ✓

...
| "Neutron-star structure from zone architecture" | §4.5 derives Tolman–Oppenheimer–Volkoff equation from (5.1.22); extends with Firmament-tension correction; compares to PSR J0740+6620 mass-radius data |
...
- Ch 5: Firmament as a Firmament, Firmament tension $\sigma$
...
- Ch 3: Linearized wave equation (5.3.10), Isaacson averaging, QNM spectrum, the Firmament-tension correction $c_\sigma$ of §3.9, the reviewer's ledger format
...
| Fig 5.4.7 | Null-geodesic dimensional bypass | §4.9, after eqn (5.4.34) | 2D $t$–$\eta$ plane showing (i) a 4D photon worldline propagating along the Firmament, and (ii) a 6D null geodesic that leaves the Firmament by $\Delta\eta$ and reaches the same destination in shorter coordinate time. Annotation: "This mechanism was used by Day-4 starlight in Vol 1 Ch 6" | Essential for showing the distinction between the 4D and 6D light cones | Diagram | Medium |
...
3. §4.5 (TOV) reproduces the textbook result and adds a named, quantified Firmament-tension correction.

...
| Ch14-005 | Derive radiation density parameter Ω_r from Firmament photon thermodynamics | V5-006 | NOT MET |
...
| Einstein field equations on the Firmament | Vol 5 Ch 1 (Eq 5.1.34) |
...
4. **Why is the universe spatially flat (Ω_k ≈ 0)?** — Because the Firmament equilibrium condition in the 6D bulk forces k = 0 (Vol 5 Ch 8, Eq 5.8.12), a consequence of bulk symmetry, not a coincidence.
...
| 11 | Baryon-to-photon ratio η_b | Zone Firmament-matter thermodynamics | η_b ≈ 6.1 × 10⁻¹⁰ | 5.14.53–5.14.56 |

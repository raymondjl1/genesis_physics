...
| R5.5.5 | Critical density $\rho_\text{crit}$ derived from Firmament tension and maximum sustainable curvature | `black_holes_membrane_punctures.docx` §2.3 |
...
- **Vol 1 Ch 11** — Thermodynamics from the zone architecture; membrane entropy counted by Firmament-surface-area.
...
4. **Why is the event horizon a one-way surface?** Because at the breach boundary every null geodesic of the induced metric points into the breach; the normal bundle of the Firmament membrane is degenerate at the breach locus. No coordinate-chart artifact.
...
6. **Why does Hawking radiation happen?** Because the Firmament membrane has vibration modes (Vol 1 §5.5) and the breach boundary is a leaky boundary at finite curvature. Full derivation in Ch 6.
...
|---|---|---|---|---|
| D1 | Effective Firmament tension profile around a spherical mass | Vol 1 §5.3 ($c^2 = \sigma/\mu$); (5.1.34) Schwarzschild | $\sigma(r) = \sigma_\infty(1 - r_s/r)$ | (5.5.4) |
...
- Entropy $S = A/(4\ell_P^2)$ from Firmament-mode counting, not by appeal to BH.

...
- **Topic sentence:** The zone framework departs from textbook GR in two places — a scalar breathing mode from the internal-space radion, and a Firmament-tension correction to orbital decay — both testable at or just below current sensitivity.
...
- **Key content:** The 8-entry scorecard; comments on each row; research-gap list (radion mass, NR assumption, Firmament-tension coefficient); what Vol 6 inherits.

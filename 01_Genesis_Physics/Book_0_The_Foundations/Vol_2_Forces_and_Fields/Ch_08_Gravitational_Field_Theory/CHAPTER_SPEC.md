...
| Maxwell's equations from membrane wave propagation | Vol 2, Ch 3 |
...
2. **Why does gravity have waves?** — Because the 4D Einstein equations (derived from the 6D action in Ch 2) are hyperbolic PDEs; their linearized form is a wave equation with propagation speed $c$, the same membrane wave speed that governs EM waves (Ch 3/7).

...
| Speed of light c² = σ/μ (membrane wave speed) | Vol 1, Ch 5 (Eq. 1.5.36) |
...
2. **Why does light bend at an interface?** — Because boundary conditions on E and B (forced by continuity of the membrane geometry across material discontinuities) require wavevector components to match, producing Snell's law.

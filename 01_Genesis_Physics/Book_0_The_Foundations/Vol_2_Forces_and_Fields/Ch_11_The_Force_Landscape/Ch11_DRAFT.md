...
$$S_{\text{total}} = S_{\text{grav}} + S_{\text{brane}} + S_{\text{waters}} + S_{\text{gauge}} + S_{\text{matter}} + S_{\text{int}} + S_{\text{sustain}}$$
...
| Firmament tension | σ ≈ 6.0×10⁹⁸ kg/s² | Sets speed of light, Planck scale |
...
| sin²θ_W (Weinberg angle) | 0.231 | 0.23122 ± 0.00003 | PDG 2022 | 0.09% |
...
The forces work the way they do because their dynamics follow from a single Lagrangian — seven sectors encoding gravity, brane mechanics, Waters fields, gauge forces, matter, interactions, and sustaining — constrained to a unique form by the Five Governing Principles. Maxwell's equations, Yang-Mills theory, and linearized general relativity all emerge as consequences, not postulates.

...
- **Key content:** Master prediction table. α⁻¹ = 137.036 (0.0013% error), α_s(M_Z) = 0.118 (1% agreement), sin²θ_W = 0.231 (0.09%), hierarchy ratio 1.236×10³⁶ (0.08%), G from membrane tension, w = −1 exactly, Ω_Λ = 0.684, Ω_DM = 0.266. Comparison figure (Fig 2.11.3).

...
In the Kaluza-Klein mechanism, electric charge q arises from momentum in the compact 5th dimension: $q = p_\xi / R$.

**(a)** Using the energy-momentum relation in 6D, $p_\mu p^\mu + p_\xi^2 = m^2$, derive the effective 4D rest mass of a particle with charge q.
...
### P2.1.4 ★★★ Extending the Four-Force: Torsion and Spin
...
### P2.2.2 ★★ Newton's Law from Zone Geometry
...
### P2.3.1 ★ Maxwell's Equations from Gauge Theory
...
### P2.3.4 ★★★ Deriving Maxwell from Torsion-Free Covariance
...
### P2.4.2 ★★ Confinement and the String Tension
...
### P2.4.4 ★★★ Weak Interactions and SU(2)
...
### P2.5.1 ★ Building the Complete Lagrangian
...
### P2.5.3 ★★ Symmetry Analysis and Noether's Theorem
...
### P2.6.3 ★★ SU(3) and the Orbifold Structure
...
### P2.8.1 ★ Linearized Einstein Equations
...
### P2.8.2 ★★ Gravitational Waves and the Quadrupole Formula
...
### P2.9.2 ★★ Volume Dilution and the Weak Scale
...
### P2.10.1 ★ Beta Functions and One-Loop Running
...
### P2.11.1 ★ Complete Scorecard of Forces
...
### P2.11.2 ★★ Falsification Criteria and Test Strategy
...
### P2.11.3 ★★ Desert Prediction and the Landscape

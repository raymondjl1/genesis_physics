...
The Firmament at $(\xi_0, \eta_0)$ is a codimension-2 brane — a 4D surface embedded in the 6D bulk (Chapter 3, equation 1.3.20). At this surface, the metric satisfies Israel junction conditions (equations 1.4.42–1.4.43):

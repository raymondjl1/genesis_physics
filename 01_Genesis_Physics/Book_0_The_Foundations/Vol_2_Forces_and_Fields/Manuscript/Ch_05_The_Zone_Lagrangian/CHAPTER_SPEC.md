...
|--------|-------------------|-----------|--------|
| Ch05-001 | Construct the complete 6D zone Lagrangian from the seven sectors: gravitational, Firmament, waters, gauge, matter, interaction, and sustaining | V2-004 (all four forces from geometry) | MET |
...
| Firmament as codimension-2 Firmament with tension σ and density μ | Vol 1, Ch 5 |
...
| 2 | Brane sector Lagrangian | Nambu-Goto + Helfrich rigidity | $\mathcal{L}_\text{Firm} = -\sigma\sqrt{-\gamma} + \kappa_B H^2\sqrt{-\gamma}$ | TBD |
...
- **Key content:** Variation with respect to $g_{AB}$ (6D Einstein equations); $\Psi_A$ and $\Psi_B$ (Waters field equations); $A_\mu^{(I)}$ (Yang-Mills equations); $\Psi$ (6D Dirac equation); Firmament embedding (Israel junction conditions). Show each recovers the equations used in Chapters 1–4.

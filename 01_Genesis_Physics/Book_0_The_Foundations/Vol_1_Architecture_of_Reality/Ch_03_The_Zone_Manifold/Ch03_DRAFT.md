...
where $A(\xi, \eta)$ and $B(\xi, \eta)$ are "warp factors" that vary with position. This is more realistic: zones far from the Firmament may experience different metric structures.

[OPEN QUESTION: What is the exact form of $A(\xi, \eta)$ and $B(\xi, \eta)$ at different zones? This depends on the distribution of the sustaining field κ, which is determined by boundary conditions from Heaven Prime.]
...
Because it satisfies all seven axioms (Chapter 1):

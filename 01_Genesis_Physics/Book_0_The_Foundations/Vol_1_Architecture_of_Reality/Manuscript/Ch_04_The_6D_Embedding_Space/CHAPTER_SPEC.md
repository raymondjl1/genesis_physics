...
| Ch4-009 | Explicit solutions in each zone: Waters Above (AdS-like), Firmament (Firmament), Waters Below (Gaussian confinement), with physical interpretation | BK-004 | NOT MET |
| Ch4-010 | Junction conditions at zone boundaries: Israel conditions, metric continuity, derivative discontinuities, Firmament tension | BK-004 | NOT MET |
...
| 6 | Zone solutions (Waters Above, Firmament, Waters Below) | Warp factor PDEs + boundary conditions | AdS-like, Firmament, Gaussian profiles | (1.4.33)–(1.4.45) |
...
- **Key content:** Waters Above (AdS-like, ξ-decaying warp factor), Firmament (Firmament at fixed ξ₀,η₀), Waters Below (Gaussian confinement in η), physical interpretation of each.
...
- **Key content:** Israel junction conditions, metric continuity, derivative discontinuities, Firmament tension, Sabbath Boundary.
...
- **Key content:** 6D Einstein equations, stress-energy decomposition (bulk fields, Firmament tension, interaction terms), Ricci tensor components, dimensional reduction preview for Vol 5.

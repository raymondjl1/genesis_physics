...
The verb suggests not modification of existing material, but the introduction of qualitatively new existence. When God *bārāʾs*, something comes into being that did not exist before—not merely rearranged, but fundamentally new.
...
*Tōhû wā-bōhû* describes the initial state of Z₂—not a state of nonexistence, but of *disorder*. The earth exists (v. 2 says "the earth was formless"), but it lacks structure, pattern, differentiation. Creation in the *bārāʾ* sense is ex nihilo *and* simultaneously orderly — the *tōhû wā-bōhû* state of Gen 1:2 describes the immediately post-*bārāʾ* unformed-but-existent material the rest of the creation week shapes.
...
The beauty of this linguistic term is that it captures the post-*bārāʾ* state precisely: the substrate has been brought into being ex nihilo, but it stands unformed, awaiting the organizing work of the creation week. *Tōhû wā-bōhû* names the state *after* the initial ex nihilo act and *before* the differentiating days that follow.

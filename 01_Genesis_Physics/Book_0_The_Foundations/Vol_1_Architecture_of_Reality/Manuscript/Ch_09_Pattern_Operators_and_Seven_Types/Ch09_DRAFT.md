...
**Proposition 9.1 (Conjecture — Pending OP-1.PO):** The seven pattern operators are conjectured to generate all connected components of the symmetry group of $S_\text{total}$ (Eq. 1.7.1) under the Five Governing Principles constraints (Eq. 1.8.38).

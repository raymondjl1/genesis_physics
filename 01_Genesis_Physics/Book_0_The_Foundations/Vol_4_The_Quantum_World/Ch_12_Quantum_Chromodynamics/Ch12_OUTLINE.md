...
- **Key content:**
  ...
  2. Argue topologically: a configuration with nonzero total winding around the η-circle cannot be continuously extended to spatial infinity on the 4D brane, because any closed 2-surface enclosing the charge must have zero total winding (Stokes in the gauge-field language). (4.12.21)

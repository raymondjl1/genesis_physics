...
- **Why entry point:** Why should the envelope of a relativistic membrane wave be the object every graduate quantum course begins with?
- **Key content:**
...
- **Key content:**
  ...
  **Inheritance 1 — The Firmament wave equation.** Vol 1 Ch 5 gave us
  ...
  with c² = σ/μ. Restate the physical meaning of each symbol. Note explicitly that ψ is real — the membrane's transverse displacement — not complex.
  ...
  **Inheritance 4 — The relativistic dispersion for a massive localized mode.** From the linearized membrane equation around a defect, Vol 1 Ch 5 Eq. (1.5.10) gave
  ω²(k) = c² k² + (m c²/ℏ)²
...
- **Key content:**
  ...
  - Two warnings:
    1. The envelope Ψ is not what the membrane displacement is. The membrane displacement is the *real part* of ψ. The envelope is a bookkeeping device for the slow modulation.
...
- **Topic sentence:** Substitute the ansatz into the membrane equation and watch the Schrödinger equation appear — provided you are willing to drop one term, and only one, and provided you can say *honestly* why.
...
- **Topic sentence:** The last step is the one everyone skips: show that V_ext(x) in the membrane equation and V(x) in the Schrödinger equation are *the same physical object*, differing only by a dimensional rescaling and a constant offset.
- **Key content:**
...
- **Key content:**
  ...
  - **Insert Fig 4.2.4** — probability current on the membrane. Two panels: left shows a Gaussian envelope translating; right shows the arrow field J(x) and the conservation law in action.
...
- **Exit condition:** Reader knows why i, why first-order, why complex, and why |Ψ|² is conserved — all from the membrane, no new postulates.

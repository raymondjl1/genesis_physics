...
- Set up the explicit form of the overlap-integral CKM entry: $V_{ij}^{\rm CKM} \propto \int d\xi\,\chi_i^{u*}(\xi)\,v(\xi)\,\chi_j^{d}(\xi)$, where the $\chi$ are the ξ-ladder bound-state profiles from Ch 10 §10.3 and $v(\xi)$ is the Higgs profile on the Firmament. [Eqs (4.13.11)–(4.13.13)]

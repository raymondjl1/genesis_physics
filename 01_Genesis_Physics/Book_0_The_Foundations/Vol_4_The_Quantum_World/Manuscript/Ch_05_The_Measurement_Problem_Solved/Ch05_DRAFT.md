...
- **Ψ_A (Waters Above (dark energy, ~68%)):** scalar field in the ξ-direction, extending from the Firmament outward to the bulk-extension boundary at ξ ≈ ξ_A ≈ 3 × 10²⁶ m (numerically close to but conceptually distinct from the Hubble radius; see Vol 1 §10.2.1).
- **Ψ_B (Waters Below (dark matter, ~27%)):** scalar field in the η-direction, confined between the Firmament and the sub-Planck boundary at η ≈ η_B ≈ 1.3 × 10⁻¹⁵ m.
...
**End-note.** Genesis 1:2 reads, "And the Spirit of God was hovering over the face of the waters." In the bulk-field architecture of Vol 1 Ch 3–4, the Spirit's hovering over the waters identifies a relational asymmetry between an ordering principle and the medium it acts upon — exactly the asymmetry that the Waters fields Ψ_A and Ψ_B formalize as a pair of bulk fields perpendicular to the Firmament. The environment that makes classical outcomes possible in this chapter is the same Waters introduced in Vol 1 Ch 6; the decoherence mechanism analyzed in §§5.3–5.4 is the dynamical content of that architectural relation.

...
| Ch6-006 | Derive the free-field Hamiltonian Ĥ = Σ_k ℏω_k (N̂_k + 1/2) from the Vol 2 Ch 5 Firmament Lagrangian | V4-QFT-DERIVATIONS | NOT MET |
...
| Zone Lagrangian and the Firmament action S_Firm | Vol 2 Ch 5, eqs. (2.5.1)–(2.5.5) |
| Gauge symmetries on the zone manifold | Vol 2 Ch 6 |
| Schrödinger equation derived from Firmament membrane dynamics | Vol 4 Ch 2 |
...
| 2 | Canonical momentum from the Firmament Lagrangian | L_Firm (eq 2.5.4), Legendre transform | π(x,t) = μ ∂ψ/∂t | (4.6.10)–(4.6.14) |
...
| 6 | Heisenberg-picture field operator and classical limit | [Ĥ, ψ̂]/(iℏ) = ∂_t ψ̂ | Recovers Firmament wave equation for ⟨ψ̂⟩ | (4.6.60)–(4.6.68) |

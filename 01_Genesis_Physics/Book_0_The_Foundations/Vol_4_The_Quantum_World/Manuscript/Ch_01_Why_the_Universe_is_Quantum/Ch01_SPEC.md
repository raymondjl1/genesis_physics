...
|---|---|---|
| QM derived from Firmament membrane dynamics | WP §Critical Deliverables | §1.4, §1.5 — architectural "why," pointer to full derivation in Ch 2 |
...
3. **The Firmament membrane** (Vol 1 Ch 5): elastic 4D Firmament with tension σ and surface density μ, obeying the wave equation μ ψ_tt = σ ∇²ψ, with c² = σ/μ. Citation: (1.5.*).
...
3. **But why is quantum mechanics *probabilistic*?** — Because the wave function is the envelope of the Firmament membrane displacement, and Firmament membrane excitations share the 4D spacetime with environmental Waters fluctuations (Vol 1 Ch 6); the Born rule is a consequence of zone-mediated decoherence (to be derived in Ch 5).
...
**Computational**
1. Compute the fundamental mode frequency of a membrane of tension σ = 6.0 × 10⁹⁸ kg/(m·s²) and surface density μ = 6.7 × 10⁸¹ kg/m³ on a 1D domain of length L = η_B. Check c² = σ/μ.

...
| 7.1 | Why extract H_int from the Lagrangian, not postulate it? | Yes — traced to Vol 2 Ch 5 Firmament Lagrangian; H_int = -L_int for non-derivative coupling justified. | PASS |

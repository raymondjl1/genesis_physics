...
- ✓ Every derivation step traces to the Firmament membrane wave equation (1.5.1) or to an inheritance cited in §2.2.
...
- ✓ Probability conservation derived from the real Firmament membrane equation, not postulated (§2.6.3).

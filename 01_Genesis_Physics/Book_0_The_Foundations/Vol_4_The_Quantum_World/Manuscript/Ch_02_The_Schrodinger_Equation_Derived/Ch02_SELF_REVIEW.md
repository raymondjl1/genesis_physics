...
| Probability conservation from real membrane | PASS | §2.6.3 derives continuity equation from (4.2.1), and the chapter is explicit that (4.2.1) itself came from the real Firmament membrane equation. |
...
| Notation consistent with Series Bible | PASS | ψ = full Firmament membrane displacement, Ψ = complex envelope, ℏ/σ/μ/c/η_B/ξ_A canonical throughout. |

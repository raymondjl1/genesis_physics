...
**"Why" entry point:** 
- The reader has now seen quantum mechanics derived from Firmament membrane dynamics (Ch 1–2) and understands uncertainty as a geometric property of 6D projection (Ch 3). Natural question: what about the strange correlations that Einstein found troubling?
...
2. **Causal structure preserved:** The zone dynamics (Firmament membrane equation, topological constraints) are governed by a relativistic action. In any Lorentz frame, the global zone state evolves according to the equations of motion, preserving the causal light-cone structure.

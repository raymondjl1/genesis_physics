...
| Ch13-010 | Three generations in the pattern-operator language. Connect §10.3 ξ-ladder bound-state count (three normalizable states) to Vol 1 Ch 9 pattern operators: the three generations are a structural consequence of the three-level bound-state problem on the membrane. The same structural fact *forces* both mixing matrices to be $3\times 3$ unitary, independent of any numerical details of the overlap integrals. | V4-002, V4-004, Vol 1 Ch 9 | NOT MET |
...
| Zone Lagrangian; 6D action functional; brane action | Vol 2 Ch 5 |
...
| 4D effective field theory from KK reduction; Higgs profile on the membrane | Vol 4 Ch 6 |

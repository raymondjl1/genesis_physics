...
- **Key content:**
  ...
  **Fact 2 — The membrane has a finite, nonzero action quantum.**
  ...
  **Combining the two facts.**
  ...
  - A classical universe is one where either (a) the extra dimensions are infinite or (b) the membrane tension or minimum scale is zero. Neither holds in zone architecture.
...
- **Exit condition:** Reader can now answer the question "why is the universe quantum" in two sentences: the extra dimensions are bounded, and the membrane has a minimum action. Both are architectural, not postulated.
...
- **Key content:**
  - Walk through the 14-chapter structure, one sentence per chapter, linking each to the inherited results it uses:
    - Ch 2 — Schrödinger as the NR envelope of the membrane wave equation.
    - Ch 3 — Uncertainty from Fourier analysis of bounded membrane modes.
    ...
    - Ch 10 — Leptons and quarks as specific membrane resonance modes. *Honest admission of open problems: spin-½ BLOCKER (#1), particle mass 1000× errors (#2).*

...
2. **Why is the quantization procedure the right move?** — Answered in §6.2 (classical field is already a sum of independent oscillators) and §6.3 (Dirac prescription applied to the brane Lagrangian forces the commutators).
...
- σ for brane tension (matches Vol 1 Ch 5). ✓

**PASS.**

### Prerequisites
- Every concept used was established in Vol 1 Ch 5 (Firmament), Vol 1 Ch 10 (mode quantization), Vol 2 Ch 5 (brane Lagrangian), Vol 3 Ch 10 (stat mech), or Vol 4 Ch 1–5.

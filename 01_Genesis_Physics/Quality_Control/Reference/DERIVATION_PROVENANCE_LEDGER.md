...
5. **Axiom-numbering inconsistency** — the `AXIOM_*.md` files vs `Axiom_Summary_Cards.md` use conflicting index numbers (Open System is "Axiom 1" and "Axiom 4"; Sustaining is "Axiom 3" and "Axiom 5"). Verses are stable; only the indices disagree. A single canonical numbering should be set.
